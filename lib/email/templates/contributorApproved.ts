...
<head>
  ...
  <title>Application Approved – ED-Library</title>
</head>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;color:#111827;letter-spacing:-0.5px;">Application Approved!</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0;font-size:14px;color:#6b7280;">Your contributor journey starts now.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom:12px;">
                    ...
                    <p style="margin:0 0 16px 0;font-size:15px;color:#374151;line-height:1.7;">
                      Great news — your application to become a contributor on <strong style="color:#2563EB;">ED-Library</strong> has been <strong style="color:#10B981;">approved</strong>! 🎉
                    </p>
                    <p style="margin:0 0 16px 0;font-size:15px;color:#374151;line-height:1.7;">
                      You now have full access to your contributor dashboard where you can create courses, upload study materials, and start earning from your knowledge.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom:28px;">
                    <div style="background-color:#F0FDF4;border:1px solid #A7F3D0;border-radius:12px;padding:20px 24px;">
                      <p style="margin:0 0 10px 0;font-size:13px;font-weight:700;color:#065F46;text-transform:uppercase;letter-spacing:0.5px;">What you can do now</p>
                      <p style="margin:0 0 8px 0;font-size:14px;color:#047857;line-height:1.6;">✅ &nbsp;Create and publish courses</p>
                      <p style="margin:0 0 8px 0;font-size:14px;color:#047857;line-height:1.6;">✅ &nbsp;Upload notes and study materials</p>
                      <p style="margin:0;font-size:14px;color:#047857;line-height:1.6;">✅ &nbsp;Earn from purchases and subscriptions</p>
                    </div>
                  </td>
                </tr>
