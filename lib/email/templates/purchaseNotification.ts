...
<head>
  ...
  <title>New Course Purchase – ED-Library</title>
</head>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;color:#111827;letter-spacing:-0.5px;">New Course Purchase!</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p style="margin:0;font-size:14px;color:#6b7280;">A student just bought one of your courses.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding-bottom:20px;">
                    ...
                    <p style="margin:0 0 20px 0;font-size:15px;color:#374151;line-height:1.7;">
                      Great news — a student has just purchased your course. Your earnings have been credited to your wallet. Here are the details:
                    </p>
                  </td>
                </tr>
                  ...
                  <td style="padding-bottom:28px;">
                    <div style="background-color:#F8F9FB;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
                      ...
                      <div style="padding:18px 24px;border-bottom:1px solid #e5e7eb;">
                        <p style="margin:0 0 4px 0;font-size:12px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Course</p>
                        <p style="margin:0;font-size:15px;font-weight:600;color:#111827;">${courseTitle}</p>
                      </div>
                      <!-- Amount row -->
                      <div style="padding:18px 24px;">
                        <p style="margin:0 0 4px 0;font-size:12px;font-weight:600;color:#9ca3af;text-transform:uppercase;letter-spacing:0.5px;">Amount Earned</p>
                        <p style="margin:0;font-size:22px;font-weight:700;color:#10B981;">&#8358;${amount.toLocaleString()}</p>
                      </div>
                    </div>
                  </td>
                </tr>
                  ...
                  <td style="padding-bottom:28px;">
                    <div style="background-color:#EFF6FF;border:1px solid #BFDBFE;border-radius:12px;padding:20px 24px;text-align:center;">
                      <p style="margin:0;font-size:14px;color:#1d4ed8;line-height:1.7;">
                        &#128293; &nbsp;Keep creating quality content to attract more students and grow your earnings!
                      </p>
                    </div>
                  </td>
                </tr>
          ...
          <tr>
            <td align="center" style="padding-top:28px;padding-bottom:8px;">
              <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
                This notification was sent because a student purchased your course on ED-Library.<br/>
