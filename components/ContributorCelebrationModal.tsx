...
export default function ContributorCelebrationModal({
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const file = new File([blob], "ed-library-contributor.png", {
        type: "image/png",
      });
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative animate-in fade-in zoom-in duration-300 flex flex-col">
        ...
        <div className="p-6 bg-gray-50 flex justify-center items-center">
          {/* 
            ...
            Using aspect-square and percentage-based positioning ensures 
            deterministic rendering and proper scaling before capturing.
          */}
          <div className="relative w-full max-w-[300px] max-h-[5000px] aspect-square rounded-xl shadow-lg border border-gray-200 overflow-hidden bg-white"
          ...
          >
            ...
            >
              ...
              <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[45%] h-[45%] rounded-full overflow-hidden border-[6px] border-white shadow-md z-10 bg-gray-100 flex items-center justify-center"
                ...
                {profileImage ? (
                  <img
                    src={profileImage.startsWith("http") ? `/_next/image?url=${encodeURIComponent(profileImage)}&w=640&q=75` : profileImage}
                    alt={contributorName}
