      ...
      >
        ...
        <div className="px-6 pb-6 pt-3 flex flex-col gap-2.5">
          <Link
            ...
            onClick={onClose}
            className="w-full py-3.5 rounded-xl font-bold text-sm text-white dark:text-black text-center transition active:scale-[0.97] flex items-center justify-center gap-2"
            style={{
          ...
          <button
            onClick={onClose}
            className="w-full py-3 rounded-xl font-semibold text-sm text-gray-400 hover:text-gray-600 dark:text-gray-400 transition"
          >
            Maybe Later
          </button>
        </div>
