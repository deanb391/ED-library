...
function TermsModal({ open, onClose, onSubmit, loading = false }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden flex flex-col max-h-[90vh]">
        ...
        {/* Content */}
        <div className="p-6 overflow-y-auto text-sm text-gray-700 dark:text-gray-300 space-y-4 leading-relaxed flex-1">
          ...
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">1. DEFINITIONS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">2. ELIGIBILITY</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">3. CONTRIBUTOR CONTENT OWNERSHIP</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">4. CONTENT WARRANTIES</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">5. PROHIBITED CONTENT</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">6. ACADEMIC INTEGRITY</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">7. CONTENT MODERATION AND REMOVAL</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">8. COPYRIGHT COMPLAINTS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">9. REVENUE SHARING</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">10. WITHDRAWALS AND PAYOUTS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">11. PLATFORM ANALYTICS, AI, AND DATA PROCESSING</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">12. NO GUARANTEE OF EARNINGS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">13. ACCOUNT SECURITY</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">14. TAX RESPONSIBILITIES</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">15. DISCLAIMERS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">16. LIMITATION OF LIABILITY</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">17. INDEMNIFICATION</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">18. TERMINATION</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">19. PRIVACY</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">20. MODIFICATIONS TO TERMS</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">21. GOVERNING LAW</h3>
          ...
          <hr className="my-6 border-gray-200 dark:border-gray-800" />
          <h3 className="text-base font-bold text-gray-900 dark:text-white mt-6 mb-2">22. CONTACT</h3>
        ...
        {/* Footer */}
        <div className="border-t border-gray-100 dark:border-gray-800 px-6 py-5 space-y-4 shrink-0 bg-gray-50 dark:bg-gray-900">

          <label className="flex items-center gap-3 text-sm text-gray-800 dark:text-gray-300 font-medium cursor-pointer select-none">
            <input
              type="checkbox"
              checked={agreed}
