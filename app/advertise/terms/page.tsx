        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="space-y-8 text-sm sm:text-base text-slate-700">
            ...
            <div className="space-y-3">
              ...
              <p className="leading-relaxed text-slate-600 pl-7 text-sm sm:text-base">
              ...
              <ul className="list-disc pl-12 space-y-1.5 text-slate-600 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="leading-relaxed text-slate-600 pl-7 text-sm sm:text-base">
                The standard Weekly Advertising Plan is priced at <strong>₦2,500 per week</strong>. A 1.5% Flutterwave payment processing fee is added at checkout. Payments are processed in full before the campaign is activated.
              </p>
              <p className="leading-relaxed text-slate-600 pl-7 text-sm sm:text-base">
