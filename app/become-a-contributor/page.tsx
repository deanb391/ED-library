        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-8">
              ...
              <p className="text-gray-300 dark:text-gray-600 text-sm font-medium">Start your journey today.</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-8" style={{ marginBottom: 40 }}>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Approval Requirement</h4>
                  <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Earnings Model</h4>
                  <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
