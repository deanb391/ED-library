        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="space-y-8 text-xs sm:text-sm text-slate-700 max-h-[60vh] overflow-y-auto pr-2">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">1. DEFINITIONS</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">2. ELIGIBILITY</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">3. CONTRIBUTOR CONTENT OWNERSHIP</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">4. CONTENT WARRANTIES</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">5. PROHIBITED CONTENT</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">6. ACADEMIC INTEGRITY</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">7. CONTENT MODERATION AND REMOVAL</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">8. COPYRIGHT COMPLAINTS</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">9. REVENUE SHARING</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">10. WITHDRAWALS AND PAYOUTS</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">11. PLATFORM ANALYTICS, AI, AND DATA PROCESSING</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">12. NO GUARANTEE OF EARNINGS</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">13. ACCOUNT SECURITY</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">14. TAX RESPONSIBILITIES</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">15. DISCLAIMERS & LIABILITY LIMITATIONS</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">16. INDEMNIFICATION</h3>
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-gray-900">17. GOVERNING LAW</h3>
