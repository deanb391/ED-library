        ...
        {showInfo && (
          ...
          >
            <div className="flex items-start gap-4 pr-10">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Important: Batch Uploading</h3>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {uploadType === 'images' ? (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Or browse from your computer</p>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">{uploadType === 'images' ? 'Total Files' : 'Files'}</span>
      ...
      {showDocReviewModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in">
          <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative p-8 text-center animate-in zoom-in-95 duration-200">
            ...
            <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-3">Document Under Review</h3>
