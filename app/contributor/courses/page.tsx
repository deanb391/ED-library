  ...
  if (userLoading || contributorLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-white">
        ...
        <p className="text-gray-700 text-sm">Loading courses...</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#F4F7F9] p-6 md:p-8 lg:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">All My Courses</h1>
            <p className="text-sm text-gray-500">Manage and view all your educational content</p>
          </div>
        </div>
            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col gap-2 grow">
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-[10px] font-medium text-gray-600 mt-auto pt-2">
