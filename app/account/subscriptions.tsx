...
export default function ActiveSubscriptionsPage() {
  return (
    <div className="min-h-screen bg-[#F8F9FB] flex flex-col font-sans text-gray-900 pb-24">
      
      {/* --- Top App Bar --- */}
      <header className="bg-[#F8F9FB] px-4 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-1.5">
          <BookOpen size={22} fill="currentColor" className="text-gray-900" />
      ...
      <main className="flex-1 px-4 py-2 w-full max-w-md mx-auto space-y-5">
        ...
        <section className="mb-6">
          <h1 className="text-[28px] font-extrabold text-gray-900 mb-2 tracking-tight leading-tight">
            Active Subscriptions
          </h1>
          <p className="text-sm text-gray-500 leading-relaxed pr-2 font-medium">
        ...
        <section className="space-y-4">
          {SUBSCRIPTIONS.map((sub) => (
            <div key={sub.id} className="bg-white rounded-[20px] overflow-hidden shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)] border border-gray-100 flex flex-col">
              ...
              <div className="relative w-full h-32 bg-gray-200">
                ...
                {/* Course Code Badge */}
                <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-sm text-gray-900 text-[10px] font-extrabold px-2.5 py-1.5 rounded-md flex items-center gap-1.5 shadow-sm uppercase tracking-wider">
              ...
              <div className="p-4">
                ...
                <p className="text-xs text-gray-500 leading-relaxed mb-4 line-clamp-2 pr-4 font-medium">
                  {sub.description}
                </p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-[#F3F4F6] hover:bg-[#E5E7EB] text-gray-900 text-[10px] font-extrabold px-3 py-2 rounded-lg uppercase tracking-widest transition-colors">
                    Manage
                  </button>
                </div>
              </div>
      ...
      <nav className="fixed bottom-0 w-full bg-white border-t border-gray-100 px-2 py-2 flex justify-around items-center pb-safe z-50">
        
        <button className="flex flex-col items-center justify-center w-16 h-14 text-gray-400 hover:text-gray-600 transition-colors">
